...
class DebertaV2Retriever(DebertaV2PreTrainedModel):
    ...
    def forward(
        ...
        for b in range(batch_size):
            ...
            stage_one_outputs = self.deberta(input_ids=question_document_ids, attention_mask=question_document_attention_mask, return_dict=True)
            ...
            stage_two_outputs = self.deberta(input_ids=question_double_document_ids, attention_mask=question_double_document_attention_mask, return_dict=True)
